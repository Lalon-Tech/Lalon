...
export const SettingsView: React.FC = () => {
  ...
  const handleClearAllData = () => {
    if (window.confirm('⚠️ সতর্কতা: আপনি কি সমস্ত ডেমো মেম্বার, ঋণ ও লেনদেন মুছে সম্পূর্ণ শূন্য (০ সদস্য) থেকে আপনার নতুন সমিতি শুরু করতে চান?')) {
      clearAllData();
      alert('সফল হয়েছে! আপনার ডাটাবেজ এখন সম্পূর্ণ খালি। আপনি এখন আপনার সমিতির আসল সদস্যদের তথ্য যোগ করতে পারেন।');
    }
  };
