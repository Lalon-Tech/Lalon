...
export const ShareClosureModal: React.FC<ShareClosureModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-900/60 backdrop-blur-xs p-3 sm:p-4 md:p-6 flex min-h-full items-center justify-center animate-fadeIn">
      <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 w-full max-w-xl overflow-hidden my-auto flex flex-col max-h-[min(92vh,calc(100dvh-2rem))] animate-in fade-in-50 zoom-in-95">
        
        {/* Success Dialog View */}
        {successModal?.show ? (
          <div className="p-8 text-center space-y-5 overflow-y-auto flex-1 min-h-0">
          ...
          <>
            {/* Modal Header */}
            <div className="bg-gradient-to-r from-amber-700 via-rose-700 to-rose-800 text-white px-6 py-4 flex items-center justify-between shrink-0">
