  ...
  return {
    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          id: '/',
          name: 'Bondhu Somiti - সমিতি ব্যবস্থাপনা সফটওয়্যার',
          short_name: 'বন্ধুসমিতি',
          description: 'সমিতি ও ক্ষুদ্রঋণ ব্যবস্থাপনা সফটওয়্যার - সঞ্চয়, ঋণ, কিস্তি এবং আর্থিক হিসাব',
          theme_color: '#059669',
